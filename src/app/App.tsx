    ...
    <section className="py-24 bg-black relative overflow-hidden">
       ...
       <div className="container mx-auto px-6 relative z-10">
         ...
         <div className="text-center mb-10 max-w-3xl mx-auto">
            ...
            <h2 className="text-4xl md:text-[36px] font-semibold text-white mb-6 tracking-[-1px]">Membresía Gamificada</h2>
            <p className="text-[#99a1af] text-[16px] leading-[26px]">
               Hemos sustituido el concepto técnico de "staking" por un sistema de Membresía por niveles basada en los golpes del pádel para incentivar la pertenencia.
            </p>
         </div>
         ...
         <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto items-stretch">
            ...
            <div className="flex flex-col rounded-[16px] overflow-hidden" style={{ backgroundImage: "linear-gradient(179.77deg, rgba(13, 13, 13, 0) 0.16%, rgb(64, 69, 10) 144.42%)" }}>
               ...
               <div className="mx-4 mb-4 bg-black/20 rounded-[10px] border border-[#413a3a] p-6 flex-1">
                  <div className="space-y-4 text-[14px] text-white">
                      ...
                      <p>Clínicas profesionales</p>
                      <p>Mayor participación</p>
                  </div>
               </div>
            </div>
            ...
            <div className="flex flex-col bg-gradient-to-b from-transparent to-[#2c2c2c] rounded-[16px] overflow-hidden">
               <div className="p-8 pb-4 flex flex-col items-center text-center gap-3">
                  <h3 className="text-white text-[36px] font-bold leading-none">Víbora</h3>
            ...
            <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
                 <GlassCard className="p-8 bg-gradient-to-b from-white/10 to-transparent border-white/5 flex flex-col items-center text-center">
                    ...
                    <p className="text-gray-300 leading-relaxed">
                      Comunicación clara y periódica sobre la evolución estratégica y económica del proyecto.
                    </p>
                 </GlassCard>
                 ...
                 <GlassCard className="p-8 bg-gradient-to-b from-white/10 to-transparent border-white/5 flex flex-col items-center text-center">
                    ...
                    <p className="text-gray-300 leading-relaxed">
                      Programa de becas y patrocinios para jóvenes deportistas, fomentando el deporte base y el talento emergente.
                    </p>
                 </GlassCard>
            </div>
        </div>
...
const App = () => {
  ...
  const [userBalance, setUserBalance] = useState(200); // Mock balance
  ...
  if (isConnected) {
    return (
      <div className="min-h-screen bg-black text-white selection:bg-[#00ffe6] selection:text-black font-sans">
        ...
        <Dashboard balance={userBalance} onDisconnect={handleDisconnect} />
        <Footer onShowStyleGuide={() => setShowStyleGuide(true)} />
      </div>
    );
  }
