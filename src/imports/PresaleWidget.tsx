import svgPaths from "./svg-4v85k2mg4";
  ...
  return (
    <div className="h-[16px] relative shrink-0 w-[96.573px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="css-ew64yg font-['Arial:Bold',sans-serif] leading-[16px] not-italic relative shrink-0 text-[#99a1af] text-[12px] text-center tracking-[1.2px] uppercase">COMPRA $PSC</p>
      </div>
    </div>
  );
}
...
function Container() {
  return (
    <div className="absolute content-stretch flex h-[37.333px] items-center justify-between left-[24px] top-[24px] w-[400.667px]" data-name="Container">
      <Container1 />
      <Container2 />
    </div>
  );
...
function NumberInput() {
  return (
    <div className="flex-[1_0_0] h-[40px] min-h-px min-w-px relative" data-name="Number Input">
...
function Text9() {
  return (
    <div className="content-stretch flex h-[18.667px] items-start relative shrink-0" data-name="Text">
...
function Container15() {
  return (
    <div className="bg-[#06160f] relative rounded-[14px] shrink-0" data-name="Container">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[11px] items-center justify-center p-[12px] relative">
        <div className="relative shrink-0 size-[20px]" data-name="usdt 1">
          <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgUsdt1} />
        </div>
        <Text9 />
      </div>
    </div>
...
function Container11() {
  return (
    <div className="absolute bg-[#020705] content-stretch flex flex-col gap-[8px] h-[107.333px] items-start left-[24px] pb-0 pt-[16px] px-[16px] rounded-[17px] top-[85.33px] w-[400.667px]" data-name="Container">
      <Container12 />
      <Container14 />
    </div>
  );
...
function Container21() {
  return (
    <div className="bg-[#06160f] relative rounded-[14px] shrink-0" data-name="Container">
      <div aria-hidden="true" className="absolute border-[0.667px] border-[rgba(255,255,255,0.1)] border-solid inset-0 pointer-events-none rounded-[14px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[11px] items-center justify-center p-[12px] relative">
        <div className="relative shrink-0 size-[20px]" data-name="Hero 1">
...
function Container16() {
  return (
    <div className="absolute bg-[#020705] h-[160.333px] left-[24px] rounded-[17px] top-[202.67px] w-[400.667px]" data-name="Container">
      <Container17 />
      <Container19 />
      <Container22 />
    </div>
...
function Container28() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[12px] h-[122.667px] items-start left-[24px] top-[379px] w-[400.667px]" data-name="Container">
      <Button />
      <Button1 />
    </div>
  );
...
export default function PresaleWidget() {
  return (
    <div className="bg-[rgba(0,0,0,0.53)] border-[0.667px] border-[rgba(255,255,255,0.1)] border-solid relative rounded-[16px] size-full" data-name="PresaleWidget">
      <Container />
      <Container11 />
      <Container16 />
      <Container28 />
