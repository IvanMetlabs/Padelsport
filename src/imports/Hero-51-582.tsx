import svgPaths from "./svg-nzkx60nfa5";
import imgLogoBlack1 from "figma:asset/14bb6c8ca043393cf68fb2e756369dc5e9b04b44.png";
import imgFreepikCreateACoinByUsingThisLogo469122 from "figma:asset/312ed84077dbdf46c9c36738bc96ef89d8e60ab6.png";
import imgHero from "figma:asset/ac4637c17e39d796f6823439bbcc12c96c23f219.png";
  ...
  return (
    <div className="h-[40px] relative shrink-0 w-[283.323px]" data-name="Number Input">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip relative rounded-[inherit] size-full">
        <p className="css-ew64yg font-['Arial:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[36px] text-[rgba(255,255,255,0.3)]">5.000,00</p>
      </div>
    </div>
  );
}
...
function Container16() {
  return (
    <div className="bg-[#06160f] relative rounded-[14px] shrink-0 w-[69.344px]" data-name="Container">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center justify-center px-[16.667px] py-[16px] relative w-full">
        <Text9 />
      </div>
    </div>
  );
...
function Container12() {
  return (
    <div className="absolute bg-[#020705] content-stretch flex flex-col gap-[8px] h-[107.333px] items-start left-[24.67px] pb-0 pt-[16px] px-[16px] rounded-[17px] top-[86px] w-[400.667px]" data-name="Container">
      <Container13 />
      <Container15 />
    </div>
  );
...
function Container21() {
  return (
    <div className="h-[40px] relative shrink-0 w-[74.031px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid overflow-clip relative rounded-[inherit] size-full">
        <p className="absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[40px] left-[33.5px] not-italic text-[36px] text-center text-white top-[-3px] translate-x-[-50%]">0.00</p>
      </div>
    </div>
  );
}
...
function Container22() {
  return (
    <div className="bg-[#06160f] relative rounded-[14px] shrink-0 w-[58.521px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[0.667px] border-[rgba(255,255,255,0.1)] border-solid inset-0 pointer-events-none rounded-[14px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center justify-center px-[16.667px] py-[16px] relative w-full">
        <Text11 />
      </div>
...
function Container17() {
  return (
    <div className="absolute bg-[#020705] h-[160.333px] left-[24.67px] rounded-[17px] top-[203.33px] w-[400.667px]" data-name="Container">
      <Container18 />
      <Container20 />
      <Container23 />
    </div>
...
function PresaleWidget() {
  return (
    <div className="bg-[rgba(0,0,0,0.25)] h-[527px] relative rounded-[16px] shrink-0 w-[450px]" data-name="PresaleWidget">
...
function Frame1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[10px] items-center justify-center min-h-px min-w-px relative w-[615px]">
      <div className="absolute flex items-center justify-center left-[-16.67px] size-[331.288px] top-[13px]" style={{ "--transform-inner-width": "2000", "--transform-inner-height": "2004" } as React.CSSProperties}>
        <div className="flex-none rotate-[0.783deg]">
          <div className="relative size-[326.854px]" data-name="freepik__create-a-coin-by-using-this-logo__46912 2">
      ...
      <div className="absolute flex items-center justify-center left-[440.27px] size-[165.772px] top-[369.93px]" style={{ "--transform-inner-width": "2000", "--transform-inner-height": "2004" } as React.CSSProperties}>
        <div className="flex-none rotate-[180.783deg] scale-y-[-100%]">
          <div className="relative size-[163.553px]" data-name="freepik__create-a-coin-by-using-this-logo__46912 3">
            <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgFreepikCreateACoinByUsingThisLogo469122} />
          </div>
        </div>
      </div>
...
export default function Hero() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-center justify-center px-[24px] py-[116px] relative size-full" data-name="Hero">
      <div aria-hidden="true" className="absolute inset-0 pointer-events-none">
        <div className="absolute inset-0 overflow-hidden">
          <img alt="" className="absolute h-[100.71%] left-[-0.02%] max-w-none top-[-0.71%] w-[100.03%]" src={imgHero} />
        </div>
